...
public final class ServerConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue REQUIRE_ONLINE = B.comment("Legacy compatibility option; offline-mode no longer blocks PasswordGate registration.").define("requireOnlineModeForRegistration", false);
    public static final ForgeConfigSpec.BooleanValue UNSAFE_OFFLINE = B.comment("Legacy compatibility option; offline-mode no longer blocks PasswordGate registration.").define("allowUnsafeOfflineMode", true);
